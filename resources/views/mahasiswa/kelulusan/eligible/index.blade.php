                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="p-0"><!--Data Induk-->
                                            <a href="{{ route('mahasiswa.yudisium.pendaftaran.data-induk') }}"
                                        ...
                                        <td class="p-0"><!--IPK-->
                                            <a href="{{ route('mahasiswa.yudisium.pendaftaran.data-akademik') }}"
                                        ...
                                        <td class="p-0"><!--TA-->
                                            <a href="{{ route('mahasiswa.yudisium.pendaftaran.data-tugas-akhir') }}"
                                        ...
                                        <td class="p-0"><!--Foto-->
                                            <a href="{{ route('mahasiswa.yudisium.pendaftaran.data-wisuda') }}"
                                        ...
                                        <td class="p-0"><!--SKPI-->
                                            <a href="{{ route('mahasiswa.yudisium.pendaftaran.data-skpi') }}"
                                        ...
                                        <td class="p-0"><!--Verifikasi Mahasiswa-->
                                            <a href="{{ route('mahasiswa.yudisium.pendaftaran.resume.index') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left align-middle" style="width:10%">
                                                    ...
                                                    @if($wisuda->finalisasi_data == 1)
                                                        ...
                                                        @endif
                                                    @else
                                                        <a type="button" href="{{route('mahasiswa.yudisium.pendaftaran.data-induk')}}" class="btn btn-sm btn-danger waves-effect waves-light"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left align-middle">
                                                    ...
                                                    @elseif($wisuda->finalisasi_data == 0)
                                                        <a type="button" href="{{route('mahasiswa.yudisium.pendaftaran.resume.index')}}" class="btn btn-sm btn-danger waves-effect waves-light"
                                                    ...
                                                    @elseif($wisuda->approved >= 2 && $wisuda->approved < 90)
                                                        <a class="btn btn-sm btn-primary my-5"
                                                            href="{{ route('mahasiswa.yudisium.formulir', ['id' => $wisuda->id]) }}"
                                                            target="_blank">
                        ...
                        <div class="col-xl-12 col-lg-12 text-center">
                            <div class="d-flex justify-content-center">
                                ...
                                <a class="btn bg-primary" 
                                    href="{{ route('mahasiswa.yudisium.pendaftaran.data-induk') }}"
            ...
            <div class="box box-outline-success bs-3 border-success">
                ...
                <div class="box box-body mb-0">
                    ...
                    <div class="row mb-5 mt-30">
                        <div class="col-xl-12 col-lg-12 text-center">
                            <div class="d-flex justify-content-center">
                                <a href="{{ route('mahasiswa.yudisium.transkrip') }}"
