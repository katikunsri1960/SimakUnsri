        ...
        <div class="col-12">
            ...
            <div class="box box-outline-success bs-3 border-success">
                <div class="box-header with-border d-flex justify-content-between align-items-center mx-20">
                    ...
                    <div>
                        @if(!$wisuda || $wisuda->finalisasi_wisuda == 0)
                        <button type="button"
                        ...
                        <table class="table table-bordered table-striped datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        @php
                                            $disabled = ($wisuda && $wisuda->finalisasi_wisuda == 1) ? 'disabled' : '';
                                        @endphp
                                        ...
                                        <form action="{{route('mahasiswa.kelulusan.wisuda.data-skpi-delete',$row->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                ...
                {{-- INCLUDE MODAL --}}
                @include('mahasiswa.kelulusan.wisuda.skpi.create')
                @include('mahasiswa.kelulusan.wisuda.skpi.edit')

                {{-- Tombol Finalisasi hanya muncul di box terakhir --}}
                @if($loop->last)
                <div class="box-footer">
                    <form action="{{route('mahasiswa.kelulusan.wisuda.data-skpi-store')}}" method="POST" id="data-skpi" >
                        @csrf
                        ...
                        <div class="form-group mt-20">
                            <a type="button" href="{{route('mahasiswa.kelulusan.wisuda.data-wisuda')}}" class="btn btn-danger waves-effect waves-light">
                                Kembali
                            </a>
                            <a type="button" href="{{route('mahasiswa.kelulusan.wisuda.resume.index')}}" class="btn btn-primary waves-effect waves-light">
                                Lanjutkan
                            </a>
                        </div>
                        @else
