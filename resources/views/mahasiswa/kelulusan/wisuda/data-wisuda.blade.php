            ...
            <div class="box box-outline-danger bs-3 border-danger">
                ...
                <div class="box-body">
                    <p class="text-danger">
                        ...
                        Saat ini periode pendaftaran wisuda belum dibuka. Silakan cek kembali pada periode berikutnya.
                    </p>
                </div>
            </div>
            @else
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('mahasiswa.kelulusan.wisuda.data-wisuda-store')}}" id="data-wisuda" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        ...
                        <h4 class="text-primary mb-0" style="padding-top: 40px;">
                            <i class="fa fa-graduation-cap"></i> Pendaftaran Wisuda - Data Wisuda
                        </h4>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="form-group mt-20">
                            <a type="button" href="{{ route('mahasiswa.kelulusan.wisuda.index') }}" class="btn btn-danger waves-effect waves-light">
                                Kembali
                            </a>
                            <a type="button" href="{{ route('mahasiswa.kelulusan.wisuda.data-skpi') }}" class="btn btn-primary waves-effect waves-light">
                                Lanjutkan
                            </a>
                        </div>
                        @else
