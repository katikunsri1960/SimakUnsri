    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                ...
                <form class="form" action="{{route('mahasiswa.kelulusan.yudisium.finalisasi')}}" id="finalisasi-data" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="box-footer">
                        ...
                        @if($wisuda && $wisuda->finalisasi_data == 1)
                            ...
                            <div class="checkbox p-3 border border-success rounded bg-light-success">
                                <input type="checkbox"
                                    id="pernyataan_data"
                                    name="pernyataan_data"
                                    checked
                                    disabled>

                                <label for="pernyataan_data" class="text-success fw-bold">
                                    Data Pendaftaran Yudisium telah difinalisasi.
                                    Perubahan data tidak diperbolehkan.
                                </label>
                            </div>
                        ...
                        @else
                            ...
                            <div class="checkbox">
                                ...
                                <label for="pernyataan_data">
                                    ...
                                    <b>Data Pendaftaran Yudisium</b> saya telah sesuai,
                                    dan tidak akan melakukan perubahan,
                                    serta saya mengizinkan data tersebut digunakan
                                    untuk keperluan Administrasi Yudisium, Wisuda,
                                    Pencetakan Ijazah, Transkrip dan SKPI.
                                </label>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-20">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    {{-- TOMBOL SIMPAN --}}
                                    <button type="submit"
                                            formaction="{{route('mahasiswa.kelulusan.yudisium.simpan')}}"
                                            class="btn btn-primary waves-effect waves-light">
...
$(document).ready(function () {
    ...
    $('#finalisasi-data').on('submit', function (e) {
        ...
        if (action.includes('save')) {
            ...
            swal({
                title: 'Simpan Data?',
                text: 'Data pendaftaran yudisium akan disimpan sebagai draft.',
                type: 'info',
        ...
        if (!pernyataan) {
            ...
            swal({
                ...
                text: 'Silakan centang pernyataan terlebih dahulu.',
                type: 'warning',
