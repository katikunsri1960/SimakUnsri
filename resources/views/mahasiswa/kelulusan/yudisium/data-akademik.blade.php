    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('mahasiswa.kelulusan.yudisium.data-akademik-store')}}" id="data-akademik" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="box-footer">
                        @if($wisuda && $wisuda->finalisasi_data == 1)
                            ...
                            <div class="form-group mt-20">
                                <a type="button" href="{{route('mahasiswa.kelulusan.yudisium.data-induk')}}" class="btn btn-danger waves-effect waves-light">
                                    Kembali
                                </a>
                                <a type="button" href="{{route('mahasiswa.kelulusan.yudisium.data-tugas-akhir')}}" class="btn btn-primary waves-effect waves-light">
                                    Lanjutkan
                                </a>
                            </div>
                        @else
