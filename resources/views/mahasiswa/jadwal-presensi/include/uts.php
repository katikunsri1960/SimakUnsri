<div class="tab-pane " id="uts" role="tabpanel">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped text-left">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Senin, 19 Maret 2024 | Pukul 08.00 - 10.30 WIB</td>
                                                                <td></td>
                                                                <td></td>
                                                                <!-- <td>
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <td>Senin, 19 Maret 2024 | Pukul 13.00 - 15.30 WIB</td>
                                                            <td></td>
                                                            <td></td>
                                                            <!-- <td>
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <td>Selasa, 20 Maret 2024 | Pukul 08.00 - 10.30 WIB</td>
                                                            <td></td>
                                                            <td></td>
                                                            <!-- <td>
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <td>Selasa, 20 Maret 2024 | Pukul 13.00 - 15.30 WIB</td>
                                                            <td></td>
                                                            <td></td>
                                                            <!-- <td>
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <td>Rabu, 21 Maret 2024 | Pukul 08.00 - 10.30 WIB</td>
                                                            <td></td>
                                                            <td></td>
                                                            <!-- <td>
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Rabu, 21 Maret 2024 | Pukul 11.00 - 11.50 WIB</td>
                                                                <td></td>
                                                                <td></td>
                                                                <!-- <td>
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <tr>
                                                                <td>8</td>
                                                                <td>ETIKA PROFESI</td>
                                                                <td>Kamis, 22 Maret 2024 | Pukul 08.00 - 10.30 WIB</td>
                                                                <td></td>
                                                                <td></td>
                                                                <!-- <td>
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
