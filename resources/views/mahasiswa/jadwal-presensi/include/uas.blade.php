<div class="tab-pane " id="uas" role="tabpanel">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12">
                                        <h3 class="fw-500 text-dark mt-0 mb-20">Jadwal dan Presensi UAS</h3>
                                    </div>                             
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped text-left">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-start">Senin, 19 Juni 2024 | Pukul 08.00 - 10.30 WIB</td>
                                                                <td class="text-start"></td>
                                                                <td class="text-start"></td>
                                                                <!-- <td class="text-center">
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <td class="text-start">Senin, 19 Juni 2024 | Pukul 13.00 - 15.30 WIB</td>
                                                            <td class="text-start"></td>
                                                            <td class="text-start"></td>
                                                            <!-- <td class="text-center">
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <td class="text-start">Selasa, 20 Juni 2024 | Pukul 08.00 - 10.30 WIB</td>
                                                            <td class="text-start"></td>
                                                            <td class="text-start"></td>
                                                            <!-- <td class="text-center">
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <td class="text-start">Selasa, 20 Juni 2024 | Pukul 13.00 - 15.30 WIB</td>
                                                            <td class="text-start"></td>
                                                            <td class="text-start"></td>
                                                            <!-- <td class="text-center">
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <td class="text-start">Rabu, 21 Juni 2024 | Pukul 08.00 - 10.30 WIB</td>
                                                            <td class="text-start"></td>
                                                            <td class="text-start"></td>
                                                            <!-- <td class="text-center">
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-start">Rabu, 21 Juni 2024 | Pukul 11.00 - 11.50 WIB</td>
                                                                <td class="text-start"></td>
                                                                <td class="text-start"></td>
                                                                <!-- <td class="text-center">
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-start">Kamis, 22 Juni 2024 | Pukul 08.00 - 10.30 WIB</td>
                                                                <td class="text-start"></td>
                                                                <td class="text-start"></td>
                                                                <!-- <td class="text-center">
                                                                    <button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-success"><i class="fa fa-list-alt"></i></button>
