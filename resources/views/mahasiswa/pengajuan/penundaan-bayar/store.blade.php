...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">Tambah Penundaan Bayar</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('prodi')}}"><i class="mdi mdi-home-outline"></i></a></li>
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('mahasiswa.penundaan-bayar.index')}}">Penundaan Bayar</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tambah Penundaan Bayar</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('mahasiswa.penundaan-bayar.store')}}" id="tambah-penundaan-bayar" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        ...
                        <h4 class="text-info mb-0 mt-40"><i class="fa fa-user"></i> Pengajuan Penundaan Bayar</h4>
                        <hr class="my-15">
                    ...
                    <div class="box-footer">
                        <a type="button" href="{{route('mahasiswa.penundaan-bayar.index')}}" class="btn btn-danger waves-effect waves-light">
                            Batal
                        </a>
...
<script>
    $(document).ready(function(){
        $('#tambah-penundaan-bayar').submit(function(e){
            e.preventDefault();
            swal({
                title: 'Penundaan Bayar',
                text: "Apakah anda yakin ingin melakukan Penundaan Bayar?",
                type: 'warning',
                ...
                if (isConfirmed) {
                    $('#tambah-penundaan-bayar').unbind('submit').submit();
                    $('#spinner').show();
                }
            });
        });
