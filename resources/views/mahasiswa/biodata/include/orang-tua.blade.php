                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->nama_ayah }}">
                                </div>
                                <div class="form-group">
                                    <label>No. HP</label>
                                    <input type="name" class="form-control" disabled
                                ...
                                <div class="form-group">
                                    <label>NIK</label>
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->nik_ayah }}">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->tanggal_lahir_ayah }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->nama_pendidikan_ayah }}">
                                </div>
                                <div class="form-group">
                                    <label>Penghasilan</label>
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->nama_penghasilan_ayah }}">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <input type="name" class="form-control" disabled
                                        value="{{$biodata->biodata->jalan }}, {{$biodata->biodata->dusun }}, RT.{{$biodata->biodata->rt }}/RW.{{$biodata->biodata->rw }}, {{$biodata->biodata->kelurahan }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Nama Lengkap</label>
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->nama_ibu_kandung }}">
                                </div>
                                <div class="form-group">
                                    <label>No. HP</label>
                                    <input type="name" class="form-control" disabled
                                ...
                                <div class="form-group">
                                    <label>NIK</label>
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->nik_ibu }}">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->tanggal_lahir_ibu }}">
                                </div>
                                <div class="form-group">
                                    <label>Status Hidup</label>
                                    <select class="form-select" disabled aria-label="Default select example">
                                ...
                                <div class="form-group">
                                    <label>Pendidikan Terakhir</label>
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->nama_pendidikan_ibu }}">
                                </div>
                                <div class="form-group">
                                    <label>Penghasilan</label>
                                    <input type="name" class="form-control" disabled
                                        value="{{ $biodata->biodata->nama_penghasilan_ibu }}">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <input type="name" class="form-control" disabled
