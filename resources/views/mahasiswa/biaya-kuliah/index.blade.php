        ...
        <div class="col-lg-12 col-xl-12 mt-5">
            <div class="box">
                ...
                <ul class="nav nav-pills justify-content-left" role="tablist">
                    <li class="nav-item bg-secondary-light rounded10"> <a class="nav-link active" data-bs-toggle="tab" href="#tagihan" role="tab"><span><i class="fa fa-money"></i></span> <span class="hidden-xs-down ms-15">KRS</span></a> </li>
