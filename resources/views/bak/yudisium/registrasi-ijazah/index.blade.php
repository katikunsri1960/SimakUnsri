            ...
            <div class="box box-outline-success bs-3 border-success">
                <div class="box-header with-border d-flex justify-content-between">
                    <div class="d-flex justify-content-start">
                        <form action="{{route('bak.yudisium.registrasi-ijazah.index')}}" method="get" id="semesterForm">
                ...
                @include('bak.yudisium.registrasi-ijazah.create')
                @include('bak.yudisium.registrasi-ijazah.edit')
                @include('bak.yudisium.registrasi-ijazah.upload')
                <div class="box-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        <form action="{{route('bak.yudisium.registrasi-ijazah.delete', $d->id)}}" method="POST"
                                            id="delete-form-{{$d->id}}">
                                            @csrf
                                            @method('delete')
...
<script>
    $(function() {
        ...
        $("#id_registrasi_mahasiswa").select2({
            ...
            ajax: {
                url: "{{route('bak.yudisium.registrasi-ijazah.get-mahasiswa')}}",
                type: "GET",
                dataType: 'json',
                delay: 250,
    ...
    function editPISN(data, id) {
        ...
        document.getElementById('editForm').action = '/bak/yudisium/registrasi-ijazah/update/' + id;
    }
