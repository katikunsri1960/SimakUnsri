                ...
                <div class="box-body p-xl-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-lg-9">
                            <h2>Daftar SKPI Jenis Kegiatan</h2>
                        ...
                        <table id="data" class="table table-bordered table-striped ">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center align-middle">Jenis Kegiatan</th>
                            ...
                            <tbody>
                                ...
                                @include('bak.skpi.jenis.edit')

                                <tr>
                                    <td class="text-center align-middle">{{$loop->iteration}}</td>
                                    <td class="text-center align-middle">{{$d->bidang->nama_bidang ?? '-' }}</td>
                                    <td class="text-center align-middle">{{$d->nama_jenis }}</td>
                                    <td class="text-center align-middle">{{$d->kriteria }}</td>
                                    <td class="text-center align-middle">{{$d->skor }}</td>
                                    <td class="text-center align-middle">
                                        <button class="btn btn-warning btn-sm mb-1" data-bs-toggle="modal" data-bs-target="#modalEdit{{ $d->id }}">
                                            <i class="fa fa-edit mr-1"></i>
                                        </button>

                                        <form action="{{route('bak.skpi.jenis.destroy',$d->id)}}" method="POST" style="display:inline" class="form-delete">
                                            @csrf
                                            @method('DELETE')
...
$(document).ready(function(){
    ...
    $('.form-create').on('submit', function(e){
        ...
        swal({
            title: "Simpan Data?",
            text: "Data jenis akan ditambahkan",
            type: "info",
            showCancelButton: true,
