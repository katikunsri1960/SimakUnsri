...
@section('title')
Kesediaan Waktu Bimbingan Dosen
@endsection
@section('content')
				...
				<div class="box-body bg-img bg-primary-light">
					<div class="d-lg-flex align-items-center justify-content-between">
						<div class="d-lg-flex align-items-center mb-30 mb-xl-0 w-p100">
							...
							<div class="ms-30">
								<h2 class="mb-10">Kesediaan Waktu Bimbingan Dosen</h2>
                ...
                <div class="box-header with-border">
                    <div class="row">
                        <div class="col-xl-4 col-lg-12 pb-20">
                            <a class="btn btn-rounded bg-warning-light" href="{{route('dosen.perkuliahan.jadwal-bimbingan')}}"><i class="fa fa-chevron-left"><span class="path1"></span><span class="path2"></span></i> Kembali</a>
                        </div>                             
                    </div>
                    <div class="row">
                        <div class="col-xl-4 col-lg-12">
                            <h3 class="fw-500 text-dark mt-0">Kesediaan Waktu Bimbingan</h3>
                        </div>                             
                    </div>
                </div>
                <!-- /.box-header -->
