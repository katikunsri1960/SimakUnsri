                    ...
                    <div class="box box-body mb-0 ">
                        <div class="row mb-5">
                            <div class="col-xl-6 col-lg-6 mb-4">
                                <a class="btn btn-rounded bg-warning-light" href="{{route('dosen.penilaian.riwayat-penilaian', ['semester_view' => $data->id_semester])}}"><i class="fa fa-chevron-left"><span class="path1"></span><span class="path2"></span></i> Kembali</a>
                            </div>
                            <div class="col-xl-6 col-lg-6 mb-4">
