                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-xl-6 col-lg-6 mb-4">
                                <form action="{{route('dosen.penilaian.penilaian-perkuliahan.pdf-dpna', ['kelas' => $data->id_kelas_kuliah])}}" method="get" target="_blank">
                                    <button type="submit" class="btn btn-rounded bg-primary-light float-end"><i class="fa fa-file-pdf"><span class="path1"></span><span class="path2"></span></i> Download DPNA PDF</button>
                                </form>
                            </div>
                        </div>
                        <hr>
