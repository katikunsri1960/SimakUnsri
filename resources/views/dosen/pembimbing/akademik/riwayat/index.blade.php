...
@section('title')
Riwayat Pembimbingan Akademik Dosen
@endsection
@section('content')
				...
				<div class="box-body bg-img bg-primary-light">
					<div class="d-lg-flex align-items-center justify-content-between">
						<div class="d-lg-flex align-items-center mb-30 mb-xl-0 w-p100">
							...
							<div class="ms-30">
								<h2 class="mb-10">Riwayat Pembimbingan Akademik Dosen</h2>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <h3 class="fw-500 text-dark mt-0">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12">
                                    <form action="{{ route('dosen.pembimbing.bimbingan-akademik.riwayat') }}" method="get" id="semesterForm">
