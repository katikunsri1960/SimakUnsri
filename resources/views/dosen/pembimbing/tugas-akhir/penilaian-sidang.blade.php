    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('dosen.pembimbing.bimbingan-tugas-akhir.penilaian-sidang.store', ['aktivitas' => $data->id])}}" id="penilaian-sidang" method="POST">
                    @csrf
                    <div class="box-body">
                        ...
                        <h4 class="text-info mb-0"><i class="fa fa-user"></i> Penilaian Proses Bimbingan Mahasiswa</h4>
                        <hr class="my-15">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <h4>Penilaian Bimbingan</h4>
                                <ul>
                                    <li>Keaktifan bimbingan</li>
                                    <li>Kreativitas</li>
                                    <li>Kerjasama</li>
