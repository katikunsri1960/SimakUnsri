    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('dosen.pembimbing.bimbingan-tugas-akhir.penilaian-langsung.store', ['aktivitas' => $data->id])}}" id="penilaian-sidang" method="POST">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input name="nilai_langsung" type="number" class="form-control" value="{{$data_nilai->nilai_angka}}">
                                </div>
                            </div>
                        </div>
                    </div>
