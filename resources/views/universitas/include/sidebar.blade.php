                    ...
                    <li class="treeview {{request()->routeIs('univ.monitoring.*') || request()->routeIs('univ.monitoring.update-akm.*') ? 'active menu-open' : ''}}">
                        ...
                        <ul class="treeview-menu">
                            <li class="{{request()->routeIs('univ.monitoring.status-mahasiswa') || request()->routeIs('univ.monitoring.status-mahasiswa.*') ? 'active' : ''}}">
                                <a href="{{route('univ.monitoring.status-mahasiswa')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Status Akd Mhs</a>
                            </li>
                            <li class="{{request()->routeIs('univ.monitoring.status-ukt') || request()->routeIs('univ.monitoring.status-ukt.*') ? 'active' : ''}}">
                                <a href="{{route('univ.monitoring.status-ukt')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Status UKT Mhs</a>
                            </li>
