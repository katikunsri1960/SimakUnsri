...
@section('title')
FEEDER UPLOAD - PERIODE PERKULIAHAN
@endsection
@section('content')
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">FEEDER UPLOAD - PERIODE PERKULIAHAN</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Pelengkap</li>
...
<script>
    function getData(){
        ...
        $.ajax({
            url: "{{ route('univ.feeder-upload.pelengkap.periode-perkuliahan.data') }}",
            type: 'GET',
            data: {
                id_prodi: id_prodi,
            ...
            success: function(response) {
                ...
                $.each(data, function(i, item) {
                    ...
                    html += '<td class="text-center">' + item.jumlah_target_mahasiswa_baru + '</td>';
                    html += '<td class="text-center">' + item.tanggal_awal_perkuliahan + '</td>';
                    html += '<td class="text-center">' + item.tanggal_akhir_perkuliahan + '</td>';
                    html += '</tr>';
                    no++;
                });
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var eventSourceUrl = "{{ route('univ.feeder-upload.pelengkap.periode-perkuliahan.upload') }}" + "?prodi=" + id_prodi + "&semester=" + id_semester;
