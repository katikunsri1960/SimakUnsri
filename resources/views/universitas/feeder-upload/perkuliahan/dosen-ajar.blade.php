...
@section('title')
FEEDER UPLOAD - DOSEN AJAR
@endsection
@section('content')
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">FEEDER UPLOAD - DOSEN AJAR</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Dosen Ajar</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <button type="submit" class="btn btn-primary btn-sm" disabled id="buttonSubmitForm"> <i
                                                class="fa fa-upload me-3"></i>Upload Dosen Ajar</button>
                                    </div>
                                </div>
                            </form>
                            <div class="row mt-3">
...
<script>
    function getData(){
        ...
        $.ajax({
            url: "{{ route('univ.feeder-upload.perkuliahan.dosen-ajar.data') }}",
            type: 'GET',
            data: {
                id_prodi: id_prodi,
