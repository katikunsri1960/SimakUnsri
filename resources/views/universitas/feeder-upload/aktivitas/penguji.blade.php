...
@section('title')
FEEDER UPLOAD - PENGUJI AKTIVITAS MAHASISWA
@endsection
@section('content')
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">FEEDER UPLOAD - PENGUJI AKTIVITAS MAHASISWA</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Penguji Aktivitas</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <button type="submit" class="btn btn-primary btn-sm" disabled id="buttonSubmitForm"> <i
                                                class="fa fa-upload me-3"></i>Upload Penguji Aktivitas</button>
                                    </div>
                                </div>
                            </form>
                            <div class="row mt-3">
...
<script>
    function getData(){
        ...
        $.ajax({
            url: "{{ route('univ.feeder-upload.aktivitas.penguji.data') }}",
            type: 'GET',
            data: {
                id_prodi: id_prodi,
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var eventSourceUrl = "{{ route('univ.feeder-upload.aktivitas.penguji.upload') }}" + "?prodi=" + id_prodi + "&semester=" + id_semester;
