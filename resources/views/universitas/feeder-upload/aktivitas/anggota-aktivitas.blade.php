...
@section('title')
FEEDER UPLOAD - ANGGOTA AKTIVITAS MAHASISWA
@endsection
@section('content')
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">FEEDER UPLOAD - ANGGOTA AKTIVITAS MAHASISWA</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Aktivitas Mahasiswa</li>
                        <li class="breadcrumb-item active" aria-current="page">Anggota Aktivitas</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <button type="submit" class="btn btn-primary btn-sm" disabled id="buttonSubmitForm"> <i
                                                class="fa fa-upload me-3"></i>Upload Anggota Aktivitas</button>
                                    </div>
                                </div>
                            </form>
                            <div class="row mt-3">
                        ...
                        <table id="dataAkm" class="table table-bordered table-hover margin-top-10 w-p100"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center align-middle">Prodi Aktivitas</th>
                                    <th class="text-center align-middle">Prodi Mahasiswa</th>
                                </tr>
                            </thead>
                            <tbody>
...
<script>
    function getData(){
        ...
        $.ajax({
            url: "{{ route('univ.feeder-upload.aktivitas.anggota.data') }}",
            type: 'GET',
            data: {
                id_prodi: id_prodi,
            ...
            success: function(response) {
                ...
                $.each(data, function(i, item) {
                    ...
                    html += '<td class="text-center">' + item.nama_jenis_peran + '</td>';
                    html += '<td class="text-center">' + item.nama_prodi + '</td>';
                    html += '<td class="text-center">' + item.prodi_mahasiswa + '</td>';
                    html += '</tr>';
                    no++;
                });
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var eventSourceUrl = "{{ route('univ.feeder-upload.aktivitas.anggota.upload') }}" + "?prodi=" + id_prodi + "&semester=" + id_semester;
