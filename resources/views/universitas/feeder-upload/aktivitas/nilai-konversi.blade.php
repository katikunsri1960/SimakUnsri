...
@section('title')
FEEDER UPLOAD - NILAI KONVERSI AKTIVITAS
@endsection
@section('content')
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">FEEDER UPLOAD - NILAI KONVERSI AKTIVITAS</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Nilai Konversi</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <button type="submit" class="btn btn-primary btn-sm" disabled id="buttonSubmitForm"> <i
                                                class="fa fa-upload me-3"></i>Upload Nilai Konversi</button>
                                    </div>
                                </div>
                            </form>
                            <div class="row mt-3">
                        ...
                        <table id="dataAkm" class="table table-bordered table-hover margin-top-10 w-p100"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center align-middle">Indeks</th>
...
<script>
    function getData(){
        ...
        $.ajax({
            url: "{{ route('univ.feeder-upload.aktivitas.nilai-konversi.data') }}",
            type: 'GET',
            data: {
                id_prodi: id_prodi,
            ...
            success: function(response) {
                ...
                $.each(data, function(i, item) {
                    ...
                    html += '<td class="text-start">' + item.nama_mata_kuliah + '</td>';
                    ...
                    html += '<td class="text-start">' + item.prodi + '</td>';
                    html += '</tr>';
                    no++;
                });
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var eventSourceUrl = "{{ route('univ.feeder-upload.aktivitas.nilai-konversi.upload') }}" + "?prodi=" + id_prodi + "&semester=" + id_semester;
