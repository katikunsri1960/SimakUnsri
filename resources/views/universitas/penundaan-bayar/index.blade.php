...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">Master Penundaan Bayar</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('univ')}}"><i class="mdi mdi-home-outline"></i></a></li>
                        <li class="breadcrumb-item active" aria-current="page">Penundaan Bayar</li>
                    </ol>
                </nav>
            </div>
        </div>
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    ...
                                    <form action="{{route('univ.p-bayar.delete', $d->id)}}" method="POST" id="delete-form-{{$d->id}}">
                                        @csrf
                                        @method('delete')
