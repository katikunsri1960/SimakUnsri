    ...
    $(function () {
        ...
        $('#data').DataTable({
            ...
            columns: [
                ...
                { data: 'kelas_kuliah', name: 'kelas_kuliah', className: 'text-center align-middle' },
                { data: 'id_kelas_kuliah', name: 'id_kelas_kuliah', className: 'text-center align-middle' }
            ]
        });
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            Swal.fire('Error', 'Gagal memulai sinkronisasi', 'error');
                            $('#start-sync').prop('disabled', false);
                            $('#progress-container').hide();
                        }
                    });
