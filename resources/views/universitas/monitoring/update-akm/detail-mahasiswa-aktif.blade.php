            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('univ.monitoring.update-akm')}}">Update AKM</a></li>
                        <li class="breadcrumb-item active" aria-current="page">List AKM Mahasiswa Aktif</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <table id="data" class="table table-hover table-bordered margin-top-10 w-p100">
                          <thead>
                             <tr>
                                ...
                                <th class="text-center align-middle">UKT</th>
                             </tr>
                          </thead>
                          <tbody>
                            @foreach ($data as $d)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">{{$d->ukt}}</td>
                                </tr>
                            @endforeach
                          </tbody>
                      </table>
