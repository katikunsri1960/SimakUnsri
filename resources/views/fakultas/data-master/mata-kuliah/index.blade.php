                                    ...
                                    <td class="text-center align-middle text-nowrap">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <form
                                                    action="{{route('fakultas.data-master.mata-kuliah.delete-prasyarat', ['matkul' => $d] )}}"
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <a class="btn btn-primary btn-sm w-100"
                                                    href="{{route('fakultas.data-master.mata-kuliah.tambah-prasyarat', ['kurikulum' => $a,'matkul' => $d])}}">
                                            ...
                                            <div class="col-md-12">
                                                <a class="btn btn-warning btn-sm w-100"
                                                    href="{{route('fakultas.data-master.mata-kuliah.lihat-rps', ['matkul' => $d->id_matkul])}}">
