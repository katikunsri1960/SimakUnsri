...
@push('header')
<div class="mx-4">
    <a href="{{route('fakultas.data-master.mata-kuliah')}}" class="btn btn-warning btn-rounded waves-effect waves-light"><i class="fa fa-arrow-left"></i> Kembali</a>
</div>
@endpush
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12  d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-end align-middle">
                            <div class="">
                                <form action="{{route('fakultas.data-master.mata-kuliah.approved-all', ['matkul' => $matkul->id_matkul])}}" method="post" id="approveAll">
                                @csrf
