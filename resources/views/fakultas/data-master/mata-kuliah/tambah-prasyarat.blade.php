                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{route('fakultas.data-master.mata-kuliah')}}">Mata Kuliah</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                ...
                <div class="box-body">
                    <form action="{{route('fakultas.data-master.mata-kuliah.store-prasyarat', ['matkul' => $matkul])}}" method="post" id="form-store">
                        @csrf
                        <div class="mb-3">
