        ...
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <div class="box-header with-border">
                    ...
                    @include('fakultas.data-master.matkul-merdeka.create')
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <form action="{{route('fakultas.data-master.matkul-merdeka.delete', $d->id)}}" method="post" class="delete-form" data-id="{{$d->id}}" id="deleteForm{{$d->id}}">
                                            @csrf
                                            @method('delete')
