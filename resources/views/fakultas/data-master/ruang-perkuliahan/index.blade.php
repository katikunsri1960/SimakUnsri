    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                ...
                @include('fakultas.data-master.ruang-perkuliahan.create')
                @include('fakultas.data-master.ruang-perkuliahan.update')
                <div class="box-body">
                            ...
                            @foreach ($data as $d)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        <form action="{{route('fakultas.data-master.ruang-perkuliahan.delete', $d->id)}}" method="POST" id="delete-form-{{$d->id}}">
                                            @csrf
                                            @method('delete')
...
<script>
    ...
    function editRuang(data, id) {
        ...
        document.getElementById('edit_kapasitas').value = data.kapasitas_ruang;
        // Populate other fields...
        document.getElementById('edit-ruang').action = '/fakultas/data-master/ruang-perkuliahan/' + id + '/update';
    }
