            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('fakultas.data-master.kurikulum')}}">List Kurikulum</a></li>
...
<section class="content">
    ...
    @include('fakultas.data-master.kurikulum.matkul-kurikulum')
</section>
@endsection
@push('js')
