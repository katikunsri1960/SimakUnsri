<div class="modal fade" id="filter-button" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('fakultas.monitoring.lulus-do')}}" method="get">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            >
                                ...
                                <option value="{{$j->id_jenis_keluar}}" {{ in_array($j->id_jenis_keluar, old('jenis_keluar', request()->get('jenis_keluar', []))) ? 'selected' : '' }}>
                                    {{$j->nama_jenis_keluar}}
                                </option>
                                @endforeach
                            </select>
