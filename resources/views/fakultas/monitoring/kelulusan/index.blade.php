            ...
            <div class="box box-outline-success bs-3 border-success">
                <div class="box-header with-border">
                    <div class="d-flex justify-content-start">
                        ...
                        @include('fakultas.monitoring.kelulusan.filter')
                        <span class="divider-line mx-1"></span>
                        <a href="{{route('fakultas.monitoring.lulus-do')}}" class="btn btn-warning waves-effect waves-light" >
...
<script>
    $(function () {
        ...
        $('#data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{route('fakultas.monitoring.lulus-do.data')}}',
                type: 'GET',
                data: function (d) {
