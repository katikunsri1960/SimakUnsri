...
@push('header')
<div class="mx-4">
    <a href="{{route('fakultas.data-akademik.sidang-mahasiswa.edit-detail', ['aktivitas' => $d->id_aktivitas])}}" class="btn btn-warning btn-rounded waves-effect waves-light"><i class="fa fa-arrow-left"></i> Kembali</a>
</div>
@endpush
    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('fakultas.data-akademik.sidang-mahasiswa.store-dosen', ['aktivitas' => $d->id_aktivitas])}}" id="tambah-dosen-penguji" method="POST">
                    @csrf
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a type="button" href="{{route('fakultas.data-akademik.sidang-mahasiswa.edit-detail', ['aktivitas' => $d->id_aktivitas])}}" class="btn btn-danger waves-effect waves-light">
                            Batal
                        </a>
