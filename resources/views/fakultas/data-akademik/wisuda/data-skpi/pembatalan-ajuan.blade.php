<div class="modal fade" id="PembatalanAjuanModal{{$d->id}}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('prodi.data-lulusan.decline', $d->id)}}" method="post" id="decline-ajuan-{{$d->id}}">
                @csrf
...
<script>
    $('#decline-ajuan-{{$d->id}}').submit(function(e){
        ...
        swal({
            ...
            if (isConfirm) {
                $('#decline-ajuan-{{$d->id}}').unbind('submit').submit();
                $('#spinner').show();
            }
        });
    });
