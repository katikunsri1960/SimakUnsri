...
@push('header')
<div class="mx-4">
    <a href="{{route('fakultas.yudisium.index')}}"
            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('fakultas.yudisium.index')}}">Wisuda</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('fakultas.yudisium.store')}}" id="tambah-wisuda" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a type="button" href="{{route('fakultas.yudisium.index')}}" class="btn btn-danger waves-effect waves-light">
                            Batal
                        </a>
