                        ...
                        <div class="box-body text-center">
                            <div class="table-responsive">
                                <div id="krsDiv" hidden>
                                    <div class="row mb-2">
                                        <form action="{{route('fakultas.data-akademik.transkrip-nilai.download')}}" method="get"
        ...
        $(document).ready(function () {
            $('#btnCari').click(function () {
                ...
                if (nim == '') {
                    ...
                    $.ajax({
                        url: '{{route('fakultas.data-akademik.transkrip-nilai.get')}}',
                        type: 'GET',
                        data: {
                            nim: nim
                        },
