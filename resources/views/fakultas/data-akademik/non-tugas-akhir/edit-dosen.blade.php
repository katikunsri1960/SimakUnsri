...
@push('header')
<div class="mx-4">
    <a href="{{route('fakultas.data-akademik.non-tugas-akhir.edit-detail', ['aktivitas' => $data->id_aktivitas])}}" class="btn btn-warning btn-rounded waves-effect waves-light"><i class="fa fa-arrow-left"></i> Kembali</a>
</div>
@endpush
    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('fakultas.data-akademik.non-tugas-akhir.update-dosen', ['bimbing' => $data->id, 'aktivitas' => $data->id_aktivitas])}}" id="ubah-dosen-pembimbing" method="POST">
                    @csrf
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a type="button" href="{{route('fakultas.data-akademik.non-tugas-akhir.edit-detail', ['aktivitas' => $data->id_aktivitas])}}" class="btn btn-danger waves-effect waves-light">
                            Batal
                        </a>
    ...
    $(document).ready(function(){
        ...
        function initializeSelect2(selectElement) {
            return selectElement.select2({
                ...
                ajax: {
                    url: "{{route('fakultas.data-akademik.non-tugas-akhir.get-dosen')}}",
                    type: "GET",
                    dataType: 'json',
                    delay: 250,
