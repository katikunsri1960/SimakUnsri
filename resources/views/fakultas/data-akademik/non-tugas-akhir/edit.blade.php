...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">Ubah Detail Aktvitas Non @if (Auth::user()->fk->nama_jenjang_pendidikan == 'S1')
                Skripsi
                @elseif (Auth::user()->fk->nama_jenjang_pendidikan == 'S2')
                Tesis
                @elseif (Auth::user()->fk->nama_jenjang_pendidikan == 'S3')
            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('fakultas.data-akademik.non-tugas-akhir')}}">Data Akademik</a></li>
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('fakultas.data-akademik.non-tugas-akhir')}}">Aktivitas Mahasiswa</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('fakultas.data-akademik.non-tugas-akhir.update-detail', ['aktivitas' => $d->id_aktivitas])}}" id="update-detail" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a type="button" href="{{route('fakultas.data-akademik.non-tugas-akhir')}}" class="btn btn-danger waves-effect waves-light">
                            Batal
                        </a>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex justify-content-end">
                                <a type="button" class="btn btn-success" href="{{route('fakultas.data-akademik.non-tugas-akhir.tambah-dosen', $d->id_aktivitas)}}"><i class="fa fa-plus"></i> Tambah Dosen</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="row d-flex justify-content-center px-3">
                                            @if (($b->approved == 1 && $b->approved_dosen == 2) || ($b->approved == 0 && $b->approved_dosen == 0))
                                                <a href="{{route('fakultas.data-akademik.non-tugas-akhir.edit-dosen', $b->id)}}" class="btn btn-warning btn-sm my-2" title="Edit"><i
                                                        class="fa fa-edit"></i> Edit
                                                </a>
                                                <form action="{{ route('fakultas.data-akademik.non-tugas-akhir.delete-dosen', ['bimbing' => $b->id]) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="row">
