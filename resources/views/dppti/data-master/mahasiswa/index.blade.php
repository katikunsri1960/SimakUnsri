...
<script>
    ...
    function getData(){
        ...
        $.ajax({
            url: "{{ route('dppti.mahasiswa.data') }}",
            type: 'GET',
            data: { 
                prodi: prodi, 
                angkatan: angkatan
                ...
                $.each(data, function(i, item) {
                    ...
                    html += `
                        <tr>
                            ...
                            <td class="text-center">${item.biodata ? item.biodata.tempat_lahir : '-'}</td>
                            <td class="text-center">${item.biodata.tanggal_lahir ? item.biodata.tanggal_lahir: '-'}</td>
                            <td class="text-center">${item.jenis_kelamin}</td>
                            <td class="text-center">${item.jalur_masuk.nama_jalur_masuk}</td>
                            
                            {{--
                            <td class="text-center">${item.biodata.nik ? item.biodata.nik : '-'}</td>
                            <td class="text-center">${item.biodata.no_hp ? item.biodata.no_hp : '-'}</td>
                            <td class="text-center">${item.biodata.nama_ayah ? item.biodata.nama_ayah : '-'}</td>
                            <td class="text-center">${item.biodata.no_hp_ayah ? item.biodata.no_hp_ayah : '-'}</td>
                            <td class="text-center">${item.biodata.nama_ibu_kandung ? item.biodata.nama_ibu_kandung : '-'}</td>
                            <td class="text-center">${item.biodata.no_hp_ibu ? item.biodata.no_hp_ibu : '-'}</td>
                            <td class="text-start">${item.biodata.alamat_orang_tua ? item.biodata.alamat_orang_tua : '-'}</td>
                            --}}

                            <td class="text-center">${item.keterangan_keluar ? item.keterangan_keluar : 'Aktif'}</td>
                            <td class="text-center">${batasBayar}</td>
                            <td class="text-center status-bayar">${statusBayar}</td>
                            ...
                            <td class="text-center">${item.nama_pembiayaan_awal}</td>
                        </tr>`;
                    no++;
                });
    ...
    $(document).ready(function () {
        $('#fakultas').on('change', function () {
            ...
            if (fakultasId) {
                $.ajax({
                    url: "{{ route('dppti.mahasiswa.get-fak-prodi-ang', '') }}/" + fakultasId,
                    type: "GET",
                    dataType: "json",
