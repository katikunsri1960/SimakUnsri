            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('prodi.data-akademik.non-tugas-akhir')}}">Aktivitas Mahasiswa</a></li>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @elseif ($b->approved == 1 && $b->approved_dosen == 0)
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="row d-flex justify-content-center px-3">
                                            @if (($b->approved == 1 && $b->approved_dosen == 2) || ($b->approved == 0 && $b->approved_dosen == 0) || ($b->approved == 1 && $b->approved_dosen == 0))
