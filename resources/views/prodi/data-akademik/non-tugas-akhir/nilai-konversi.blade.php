    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('prodi.data-akademik.kelas-penjadwalan.dosen-pengajar.store', ['id_matkul' => $id_matkul, 'nama_kelas_kuliah' => $kelas[0]['nama_kelas_kuliah']])}}" id="tambah-konversi" method="POST">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <p>*Notes Jumlah total dari seluruh sks tidak boleh melebihi batas sks konversi mahasiswa.</p>
    ...
    $(document).ready(function(){
        ...
        function initializeSelect2(selectElement) {
            return selectElement.select2({
                ...
                ajax: {
                    url: "{{route('prodi.data-akademik.non-tugas-akhir.get-matkul', ['id_reg' => $data->anggota_aktivitas_personal->nim])}}",
                    type: "GET",
                    dataType: 'json',
                    delay: 250,
