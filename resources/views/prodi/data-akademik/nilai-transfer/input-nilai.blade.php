    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('prodi.data-akademik.nilai-transfer-rpl.store', ['id_reg' => $d->id_registrasi_mahasiswa])}}" id="tambah-transfer" method="POST">
                    @csrf
                    <div class="box-body">
                        <h4 class="text-info mb-0"><i class="fa fa-university"></i> Detail Mahasiswa</h4>
                        <hr class="my-15">
    ...
    $(document).ready(function(){
        ...
        function initializeSelect2(selectElement) {
            return selectElement.select2({
                ...
                ajax: {
                    url: "{{route('prodi.data-akademik.nilai-transfer-rpl.get-matkul', ['nim' => $d->nim])}}",
                    type: "GET",
                    dataType: 'json',
                    delay: 250,
        ...
        function initializeSelect2allPt(selectElement) {
            return selectElement.select2({
                ...
                minimumInputLength: 3,
                ajax: {
                    url: "{{route('prodi.data-akademik.nilai-transfer-rpl.get-all-pt')}}",
                    type: "GET",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
