...
@push('header')
<div class="mx-4">
    <a href="{{route('prodi.data-akademik.tugas-akhir.edit-detail', ['aktivitas' => $data->id_aktivitas])}}" class="btn btn-warning btn-rounded waves-effect waves-light"><i class="fa fa-arrow-left"></i> Kembali</a>
</div>
@endpush
    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('prodi.data-akademik.tugas-akhir.update-dosen', ['bimbing' => $data->id, 'aktivitas' => $data->id_aktivitas])}}" id="ubah-dosen-pembimbing" method="POST">
                    @csrf
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a type="button" href="{{route('prodi.data-akademik.tugas-akhir.edit-detail', ['aktivitas' => $data->id_aktivitas])}}" class="btn btn-danger waves-effect waves-light">
                            Batal
                        </a>
