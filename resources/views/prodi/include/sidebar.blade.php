            ...
            <div class="multinav-scroll" style="height: 100%;">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    {{-- <li class="treeview {{request()->routeIs('prodi.kurikulum') | request()->routeIs('prodi.mata-kuliah') ? 'active menu-open' : ''}}">
                        ...
                        <ul class="treeview-menu">
                            <li class="{{request()->routeIs('prodi.kurikulum') ? 'active' : ''}}"><a href="{{route('prodi.kurikulum')}}"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>List Kurikulum</a>
                            </li>
                            <li class="{{request()->routeIs('prodi.mata-kuliah') ? 'active' : ''}}">
                                <a href="{{route('prodi.mata-kuliah')}}"><i class="icon-Commit"><span
