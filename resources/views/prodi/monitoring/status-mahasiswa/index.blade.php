                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        <a
                                            href="{{route('prodi.monitoring.status-mahasiswa.detail-prodi', ['id' => $item->id, 'status' => 'lewat_10_semester'])}}">
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        <a
                                            href="{{route('prodi.monitoring.status-mahasiswa.detail-prodi', ['id' => $item->id, 'status' => 'mahasiswa_lewat_semester'])}}">
