...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">Data Ajuan SKPI {{$wisuda->riwayat_pendidikan->nama_mahasiswa}}</h3>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="box box-outline-success bs-3 border-success">
                        ...
                        <table class="table table-bordered table-striped datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-start">{{ $d->tahun }}</td>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @if($d->approved == 0 && $wisuda->finalisasi_data == 1)
                                        <button
                                            type="button"
                                            class="btn btn-success btn-sm my-1"
                                            data-bs-toggle="modal"
                                            data-bs-target="#modalSkpiApprove{{$bidang->id}}-{{$d->id}}">
                                        ...
                                        <button
                                            ...
                                            data-bs-toggle="modal"
                                            data-bs-target="#modalSkpiDecline{{$bidang->id}}-{{$d->id}}">
                ...
                {{-- INCLUDE MODAL --}}
                @include('prodi.data-skpi.approve')
                @include('prodi.data-skpi.decline')
            </div>
            @endforeach
        </div>
    </div>
