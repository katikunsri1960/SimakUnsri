            ...
            <div class="box box-outline-success bs-3 border-success">
                <div class="box-body">
                    ...
                    <h4>
                        ...
                        @elseif($data->status_masa_studi != 1)
                            <span class="badge badge-lg badge-danger">Masa studi melebihi syarat kelulusan / Fakultas Belum Menginput SK Yudisium</span>
                ...
                <div class="box-footer text-end">
                    <form action="{{route('prodi.data-lulusan.approved', $data->id)}}"
                        ...
                        @if ($data->ipk_transkrip_akm != 1 || $data->status_ipk != 1 || $data->jumlah_sks != 1 || $data->sks_transkrip_akm != 1 || $data->status_masa_studi != 1 || $data->approved == 1 || $data->approved == 2 || $data->approved == 3)
