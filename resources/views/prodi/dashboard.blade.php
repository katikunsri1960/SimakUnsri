...
<section class="content">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-lg-9">
                            ...
                            <p class="text-dark mb-0 fs-16">
                                Sistem Informasi Akademik (SIMAK) Universitas Sriwijaya
                            </p>
                        </div>
                    </div>
                </div>
    ...
    {{-- <div class="row">
        ...
        <div class="col-xl-3 col-md-6 col-12">
            <div class="box bg-secondary-light pull-up"
                style="background-image: url({{asset('images/images/svg-icon/color-svg/st-2.svg')}}); background-position: right bottom; background-repeat: no-repeat;">
                <div class="box-body">
                    <div class="flex-grow-1">
                        <div class="d-flex align-items-center pe-2 justify-content-between">
                            <div class="d-flex">
