            ...
            <div class="box box-outline-success bs-3 border-success">
                <div class="box-header with-border">
                    <div class="d-flex justify-content-end">
                       <div class="btn-group">
                            <a class="btn btn-success waves-effect waves-light" href="{{route('prodi.data-aktivitas.aktivitas-mahasiswa.create')}}"><i class="fa fa-plus"><span class="path1"></span><span class="path2"></span></i> Tambah BKU Prodi</a>
                        </div>   
                    </div>
                </div>
                <div class="box-body">
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td class="text-center align-middle" style="width:3%">
                                            <form action="{{ route('prodi.data-master.detail-prodi.ubah') }}" method="POST" class="delete-form">
                                                @csrf
                                                @method('GET')
                                            ...
                                            <form action="{{ route('prodi.data-master.detail-prodi.delete') }}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
