<div class="modal fade" id="TambahBKU" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="form" action="{{route('prodi.data-master.detail-prodi.store-bku')}}" id="create-bku" method="POST">
                @csrf
...
<script>
    const myModal = new bootstrap.Modal(
                        document.getElementById("TambahBKU"),
                        options,
                    );
</script>
@endpush
