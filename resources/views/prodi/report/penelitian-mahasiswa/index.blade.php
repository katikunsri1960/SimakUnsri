...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">Penelitian Mahasiswa</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('prodi')}}"><i class="mdi mdi-home-outline"></i></a></li>
                        <li class="breadcrumb-item" aria-current="page">Report</li>
                        <li class="breadcrumb-item active" aria-current="page">Penelitian Mahasiswa</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td class="text-center align-middle" style="width: 15%">{{$d->anggota_aktivitas_personal ? $d->anggota_aktivitas_personal->nim : '-'}}</td>
                                        <td class="text-center align-middle" style="width: 15%">{{$d->anggota_aktivitas_personal ? $d->anggota_aktivitas_personal->nama_mahasiswa : '-'}}
                                        </td>
                                        <td class="text-center align-middle text-nowrap">
                                            {{$d->judul}}
                                        </td>
                                        <td class="text-center align-middle" style="width: 15%">
                                            {{substr($d->id_semester,0,4)}}
                                        </td>
                                        <td class="text-center align-middle" style="width: 15%">
                                            {{$d->lokasi}}
                                        </td>
