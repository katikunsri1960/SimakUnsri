...
@section('title')
Aktivitas Lomba Mahasiswa
@endsection
@section('content')
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">Aktivitas Lomba Mahasiswa</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('prodi')}}"><i class="mdi mdi-home-outline"></i></a></li>
                        <li class="breadcrumb-item" aria-current="page">Data Aktivitas</li>
                        <li class="breadcrumb-item active" aria-current="page">Aktivitas Lomba</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <table id="data" class="table table-hover margin-top-10 w-p100">
                          <thead>
                             <tr>
                                ...
                                <th class="text-center align-middle">JENIS LOMBA</th>
                                <th class="text-center align-middle">TAHUN LOMBA</th>
                                <th class="text-center align-middle">PENGHARGAAN</th>
