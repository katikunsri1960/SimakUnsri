...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">Tambah Konversi Aktivitas</h3>
    ...
    <div class="row">
        <div class="col-12">
            <div class="box box-outline-success bs-3 border-success">
                <form class="form" action="{{route('prodi.data-aktivitas.aktivitas-mahasiswa.store')}}" id="tambah-konversi-aktivitas" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
...
<script>
    $(document).ready(function(){
        $('#tambah-konversi-aktivitas').submit(function(e){
            e.preventDefault();
            swal({
                ...
                if (isConfirmed) {
                    $('#tambah-konversi-aktivitas').unbind('submit').submit();
                    $('#spinner').show();
                }
            });
        });
