...
function getData()
{
    ...
    if (!fakultas) {
        swal('Peringatan', 'Silakan pilih fakultas terlebih dahulu', 'warning');
        return;
    }

    if (!prodi) {
        swal('Peringatan', 'Silakan pilih prodi terlebih dahulu', 'warning');
        return;
    }

    if (!periode) {
        swal('Peringatan', 'Silakan pilih periode wisuda terlebih dahulu', 'warning');
        return;
    }
