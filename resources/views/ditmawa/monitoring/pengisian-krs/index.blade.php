                            ...
                            @endphp
                                <tr class="@if ($persentase_approval < 50) table-danger @endif">
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="{{route('ditmawa.monitoring.pengisian-krs.detail-mahasiswa-aktif', ['prodi' => $d->prodi->id])}}">
                                            {{$d->mahasiswa_aktif}}
                                        </a>

                                    </td>
                                    <td class="text-center align-middle">
                                        <a href="{{route('ditmawa.monitoring.pengisian-krs.detail-aktif-min-tujuh', ['prodi' => $d->prodi->id])}}">
                                            {{$d->mahasiswa_aktif_min_7}}
                                        </a>
                                    </td>
                                    <td class="text-center align-middle">
                                        @if ($d->mahasiswa_aktif - $d->mahasiswa_aktif_min_7 > 0)
                                        <a href="{{route('ditmawa.monitoring.pengisian-krs.mahasiswa-up-tujuh', ['prodi' => $d->prodi->id])}}"  target="_blank">
                                    ...
                                    <td class="text-center align-middle">
                                        @if ($d->isi_krs > 0)
                                        <a href="{{route('ditmawa.monitoring.pengisian-krs.detail-isi-krs', ['prodi' => $d->prodi->id])}}">
                                            {{$d->isi_krs}}
                                        </a>
                                        @else
                                            0
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        <a href="{{route('ditmawa.monitoring.pengisian-krs.tidak-isi-krs', ['prodi' => $d->prodi->id])}}"  target="_blank">
                                    ...
                                    <td class="text-center align-middle">
                                        @if ($d->krs_approved > 0)
                                        <a href="{{route('ditmawa.monitoring.pengisian-krs.detail-approved-krs', ['prodi' => $d->prodi->id])}}">
                                        {{$d->krs_approved}}
                                        </a>
                                        @else
                                            0
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        <a href="{{route('ditmawa.monitoring.pengisian-krs.detail-not-approved-krs', ['prodi' => $d->prodi->id])}}">
                                            {{$d->krs_not_approved}}
                                            </a>
                                        @else
                                            0
