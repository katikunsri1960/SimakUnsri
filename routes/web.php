    ...
    Route::group(['middleware' => ['role:dosen']], function() {
        ...
        Route::prefix('dosen')->group(function () {
            ...
            Route::prefix('penilaian')->group(function () {
                ...
                Route::get('/komponen-evaluasi/store/{kelas}', [App\Http\Controllers\Dosen\Penilaian\PresentasePenilaianController::class, 'komponen_evaluasi_store'])->name('dosen.penilaian.komponen-evaluasi.store');
