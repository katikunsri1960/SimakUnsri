...
class MonitoringController extends Controller
{
    public function pengisian_krs()
    {
        ...
        return view('dppti.monitoring.pengisian-krs.index', [
            'data' => $data,
        ]);
    }
    ...
    public function detail_mahasiswa_aktif(ProgramStudi $prodi)
    {
        ...
        return view('dppti.monitoring.pengisian-krs.detail-mahasiswa-aktif', [
            'prodi' => $prodi,
            'data' => $data
        ]);
    }
    ...
    public function detail_aktif_min_tujuh(ProgramStudi $prodi)
    {
        ...
        return view('dppti.monitoring.pengisian-krs.detail-aktif-min-tujuh', [
            'prodi' => $prodi,
            'data' => $data
        ]);
    }
    ...
    public function detail_isi_krs(ProgramStudi $prodi)
    {
        ...
        return view('dppti.monitoring.pengisian-krs.detail-isi-krs', [
            'prodi' => $prodi,
            'data' => $data
        ]);
    }
    ...
    public function detail_approved_krs(ProgramStudi $prodi)
    {
        ...
        return view('dppti.monitoring.pengisian-krs.approve-krs', [
            'prodi' => $prodi,
            'data' => $data
        ]);
    }
    ...
    public function detail_not_approved_krs(ProgramStudi $prodi)
    {
        ...
        return view('dppti.monitoring.pengisian-krs.not-approve-krs', [
            'prodi' => $prodi,
            'data' => $data
        ]);
    }
    ...
    public function tidak_isi_krs(ProgramStudi $prodi)
    {
        ...
        return view('dppti.monitoring.pengisian-krs.tidak-isi-krs', [
            'prodi' => $prodi,
            'data' => $data
        ]);
    }
    ...
    public function mahasiswa_up_tujuh(ProgramStudi $prodi)
    {
        ...
        return view('dppti.monitoring.pengisian-krs.mahasiswa-up-tujuh', [
            'prodi' => $prodi,
            'data' => $data
        ]);
    }
    ...
    public function lulus_do(Request $request)
    {
        ...
        return view('dppti.monitoring.kelulusan.index', [
    ...
    public function pengisian_nilai()
    {
        ...
        return view('dppti.monitoring.pengisian-nilai.index', [
            'fakultas' => $fakultas,
            'prodi' => $prodi,
            'semester' => $semester,
    ...
    public function pengisian_nilai_detail(string $mode, string $dosen, string $prodi)
    {
        ...
        return view('dppti.monitoring.pengisian-nilai.detail', [
            'title' => $title,
            'data' => $data,
            'dosen' => $biodataDosen,
        ]);
    ...
    public function status_mahasiswa()
    {
        ...
        return view('dppti.monitoring.status-mahasiswa.index', [
            'data' => $data,
            'prodi' => $prodi
        ]);
    }
    ...
    public function detail_total_status_mahasiswa($semester, $status)
    {
        ...
        return view('dppti.monitoring.status-mahasiswa.detail-total', [
            'data' => $data,
            'status' => $status
        ]);
    }
    ...
    public function detail_prodi_status_mahasiswa(int $id, string $status)
    {
        ...
        return view('dppti.monitoring.status-mahasiswa.detail-prodi', [
            'data' => $data,
            'status' => $status
        ]);
    }
    ...
    public function status_aipt()
    {
        ...
        return view('dppti.monitoring.status-aipt.devop', [
            // 'data' => $data,
            // 'prodi' => $prodi
        ]);
    }
    ...
    public function status_ukt(Request $request)
    {
        ...
        return view('dppti.monitoring.status-ukt.index', [
            'angkatan' => $angkatan,
            'prodi'    => $prodi_fak,
            'fakultas' => $fakultas,
    ...
    public function cpl(Request $request)
    {
        ...
        return view('dppti.monitoring.capaian-pembelajaran.index', compact('data'));
    }
    ...
    public function detail_cpl(Request $request)
    {
        ...
        return view('dppti.monitoring.capaian-pembelajaran.detail', compact(
            'data',
            'prodi',
            'title'
        ));
