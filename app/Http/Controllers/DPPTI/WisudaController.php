...
class WisudaController extends Controller
{
    ...
    public function pengaturan()
    {
        ...
        return view('dppti.wisuda.pengaturan.index', [
            'data' => $data,
            'periode' => $periode,
        ]);
    }
    ...
    public function pengaturan_store(Request $request)
    {
        ...
        return redirect()->route('dppti.wisuda.pengaturan')->with('success', 'Data berhasil ditambahkan');
    ...
    public function pengaturan_update(Request $request, PeriodeWisuda $periodeWisuda)
    {
        ...
        return redirect()->route('dppti.wisuda.pengaturan')->with('success', 'Data berhasil diubah');
    }
    ...
    public function pengaturan_delete(PeriodeWisuda $periodeWisuda)
    {
        ...
        return redirect()->route('dppti.wisuda.pengaturan')->with('success', 'Data berhasil dihapus');
    }
    ...
    public function peserta()
    {
        ...
        return view('dppti.wisuda.peserta.index', [
            'fakultas' => $fakultas,
            'prodi' => $prodi,
            'periode' => $periode,
    ...
    public function peserta_formulir(Wisuda $id)
    {
        ...
        $pdf = Pdf::loadView('dppti.wisuda.peserta.formulir', [
            'riwayat'    => $riwayat,
            'biodata'    => $biodata,
            'aktivitas'  => $aktivitas,
            'pt'         => $pt,
    ...
    public function approve(Request $request, $id)
    {
        ...
        if (! LulusDo::where('id_registrasi_mahasiswa', $wisuda->id_registrasi_mahasiswa)->exists()) {
            ...
            return response()->json([
                'status' => 'error',
                'message' => 'Mahasiswa ini belum memiliki data Lulus DO.',
            ], 422);
        }
    ...
    public function registrasi_ijazah(Request $request)
    {
        ...
        // dd($data[0]->lulus_do);
        return view('dppti.wisuda.registrasi-ijazah.index', compact('data', 'semester'));
    }
...
//  dd($data);
    ...
    {
        return view('dppti.wisuda.perbaikan-data.index');
    }
    ...
    public function ijazah(Request $request)
    {
        ...
        return view('dppti.wisuda.ijazah.index', [
            'fakultas' => $fakultas,
            'periode' => $periode,
            'prodi' => $prodi,
        ]);
    ...
    public function ijazah_download_pdf(Request $request)
    {
        ...
        // dd($dekan, $rektor);
                                ...
                                // dd($data[0]->wisuda_ke);
        $pdf = PDF::loadview('dppti.wisuda.ijazah.pdf', [
            'data' => $data,
            'kode_univ' => $kode_univ,
            'fakultas' => $fakultas,
            'rektor' => $rektor,
    ...
    // {
    //     return view('dppti.wisuda.transkrip.index');
    // }
    ...
    public function transkrip_download_pdf(Request $request)
    {
        ...
        // $pdf = PDF::loadview('dppti.wisuda.transkrip.pdf', [
        //     'data' => $data,
        //     'kode_univ' => $kode_univ,
        //     'fakultas' => $fakultas,
        //     'wr1' => $wr1,
    ...
    public function album(Request $request)
    {
        ...
        return view('dppti.wisuda.album.index', [
            'fakultas' => $fakultas,
            'periode' => $periode,
            'prodi' => $prodi,
        ]);
    ...
    public function album_download_pdf(Request $request)
    {
        ...
        $pdf = PDF::loadView('dppti.wisuda.album.pdf', [
            'data' => $data,
    ...
    {
        return view('dppti.wisuda.usept.index');
    }
}
