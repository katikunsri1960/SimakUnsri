...
class DataMasterController extends Controller
{
    ...
    public function dosen()
    {
        ...
        return view('dppti.data-master.dosen.index', [
            'data' => $data
        ]);
    }
    ...
    public function gelar_dosen()
    {
        ...
        return view('dppti.data-master.dosen.gelar', [
            'data' => $data
        ]);
    }
    // DOSEN END
    ...
    public function mahasiswa(Request $request)
    {
        ...
        return view('dppti.data-master.mahasiswa.index', [
            'angkatan' => $angkatan,
            'prodi'    => $prodi_fak,
            'fakultas' => $fakultas,
    ...
    public function predikat()
    {
        ...
        return view('dppti.data-master.predikat.index', [
            'data' => $data,
        ]);
    }
    ...
    public function predikat_store(Request $request)
    {
        ...
        return redirect()->route('dppti.data-master.predikat')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function predikat_update(Request $request, PredikatKelulusan $predikat)
    {
        ...
        return redirect()->route('dppti.data-master.predikat')->with('success', 'Data berhasil diupdate');
    }
    ...
    public function predikat_delete(PredikatKelulusan $predikat)
    {
        ...
        return redirect()->route('dppti.data-master.predikat')->with('success', 'Data berhasil dihapus');
    }
