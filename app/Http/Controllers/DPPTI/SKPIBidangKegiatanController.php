...
class SKPIBidangKegiatanController extends Controller
{
    public function index()
    {
        $data = SKPIBidangKegiatan::orderBy('nama_bidang', 'ASC')
            ->get();
        return view('dppti.skpi.bidang.index', compact('data'));
    }

    public function create()
    {
        return view('dppti.skpi.bidang.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dppti.skpi.bidang.index')
    ...
    public function edit($id)
    {
        ...
        return view('dppti.skpi.bidang.edit', compact('data'));
    }
