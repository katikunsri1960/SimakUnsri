...
class PrestasiMahasiswaController extends Controller
{
    ...
    public function store_prestasi_mahasiswa_non_pendanaan(Request $request)
    {
        ...
        for($i=0;$i<$jumlah_prestasi;$i++){
            ...
            $tingkat_prestasi = TingkatPrestasi::where('id_jenis_prestasi', $request->tingkat_prestasi[$i])->first();

            PrestasiMahasiswa::create(['id_prestasi' => $id_prestasi_mahasiswa, 'id_mahasiswa' => $mahasiswa->id_mahasiswa, 'nama_mahasiswa' => $mahasiswa->nama_mahasiswa, 'id_jenis_prestasi' => $jenis_prestasi->id_jenis_prestasi, 'nama_jenis_prestasi' => $jenis_prestasi->nama_jenis_prestasi, 'id_tingkat_prestasi' => $tingkat_prestasi->id_tingkat_prestasi, 'nama_tingkat_prestasi' => $tingkat_prestasi->nama_tingkat_prestasi, 'nama_prestasi' => $request->nama_prestasi[$i], 'tahun_prestasi' => $request->tahun_prestasi[$i], 'penyelenggara' => $request->penyelenggara[$i]]);
        }
