...
class TugasAkhirController extends Controller
{
    ...
    public function ubah_detail_tugas_akhir($aktivitas)
    {
        ...
        return view('fakultas.data-akademik.tugas-akhir.edit', [
            'd' => $data
        ]);
    }
    ...
    public function tambah_dosen_pembimbing($aktivitas)
    {
        ...
        return view('fakultas.data-akademik.tugas-akhir.tambah-dosen', [
            'd' => $data,
            'kategori' => $kategori
        ]);
    }
    ...
    public function store_dosen_pembimbing($aktivitas, Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('fakultas.data-akademik.tugas-akhir.edit-detail', $aktivitas)->with('success', 'Data Berhasil di Tambahkan');
