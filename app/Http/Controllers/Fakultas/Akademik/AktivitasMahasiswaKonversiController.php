...
class AktivitasMahasiswaKonversiController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return view('fakultas.data-aktivitas.aktivitas-mahasiswa.update', ['mk_konversi' => $mk_konversi, 'jenis_aktivitas' => $jenis_aktivitas, 'kurikulum_aktif' => $kurikulum_aktif]);
    }
