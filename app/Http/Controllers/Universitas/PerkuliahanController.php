...
class PerkuliahanController extends Controller
{
    ...
    private function sync2($act, $limit, $offset, $order, $job, $name, $model, $primary)
    {
        ...
        $semester = Semester::whereNotIn('id_semester', [20261,20253])->pluck('id_semester')->toArray();
...
//      dd($validatedData);
    ...
    public function aktivitas_kuliah_edit($id)
    {
        ...
        // Ambil daftar semester untuk ditampilkan di dropdown
    ...
    public function aktivitas_kuliah_update(Request $request, $id)
    {
        ...
        $semester = Semester::where('id_semester', $validated['id_semester'])->first();
        ...
        try {
            ...
            $validated['nama_semester'] = $semester->nama_semester ?? '-';
    ...
    public function aktivitas_kuliah_data(Request $request)
    {
        ...
        $query = AktivitasKuliahMahasiswa::with('pembiayaan')->join('pembiayaans', 'aktivitas_kuliah_mahasiswas.id_pembiayaan', 'pembiayaans.id_pembiayaan')->select('aktivitas_kuliah_mahasiswas.*', 'pembiayaans.id_pembiayaan', 'pembiayaans.nama_pembiayaan');
    ...
    public function aktivitas_mahasiswa_data(Request $request)
    {
        ...
        $query = AktivitasMahasiswa::with(['anggota_aktivitas_personal', 'bimbing_mahasiswa_approved'])->leftJoin('program_studis as prodi', 'aktivitas_mahasiswas.id_prodi', 'prodi.id_prodi');
