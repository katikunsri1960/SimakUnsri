...
class PembimbingMahasiswaController extends Controller
{
    ...
    public function penilaian_langsung_store(Request $request, $aktivitas)
    {
        ...
        if ($nilai_langsung >= 86 && $nilai_langsung <= 100) {
            $nilai_indeks = '4.00';
            $nilai_huruf = 'A';
        } elseif ($nilai_langsung >= 71 && $nilai_langsung < 86) {
            $nilai_indeks = '3.00';
            $nilai_huruf = 'B';
        } elseif ($nilai_langsung >= 56 && $nilai_langsung < 71) {
            $nilai_indeks = '2.00';
            $nilai_huruf = 'C';
        } elseif ($nilai_langsung >= 41 && $nilai_langsung < 56) {
            $nilai_indeks = '1.00';
            $nilai_huruf = 'D';
        } elseif ($nilai_langsung >= 0 && $nilai_langsung < 41) {
            $nilai_indeks = '1.00';
            $nilai_huruf = 'D';
        } else {
