...
class JadwalKuliahController extends Controller
{
    public function jadwal_kuliah()
    {
        ...
        $data = DosenPengajarKelasKuliah::LeftJoin('kelas_kuliahs', 'kelas_kuliahs.id_kelas_kuliah', 'dosen_pengajar_kelas_kuliahs.id_kelas_kuliah')->LeftJoin('semesters', 'semesters.id_semester', 'dosen_pengajar_kelas_kuliahs.id_semester')->LeftJoin('ruang_perkuliahans', 'ruang_perkuliahans.id', 'kelas_kuliahs.ruang_perkuliahan_id')->LeftJoin('mata_kuliahs', 'mata_kuliahs.id_matkul', 'kelas_kuliahs.id_matkul')->where('dosen_pengajar_kelas_kuliahs.id_dosen', $id_dosen)->where('dosen_pengajar_kelas_kuliahs.id_semester', $semester_aktif->id_semester)->get();
