    ...
    */
    ...
    private function afterSheet(AfterSheet $event)
    {
        ...
        for ($row = 2; $row <= $highestRow; $row++) {
            $cell = 'O' . $row;
            //NEW FORMULA
            $formula = "=IF(F$row>=2025,IFS(M$row>={$this->batas_min_A},\"A\",M$row>={$this->batas_min_A_min},\"A-\",M$row>={$this->batas_min_B_plus},\"B+\",M$row>={$this->batas_min_B},\"B\",M$row>={$this->batas_min_B_min},\"B-\",M$row>={$this->batas_min_C_plus},\"C+\",M$row>={$this->batas_min_C},\"C\",M$row>={$this->batas_min_D},\"D\",M$row>={$this->batas_min_E},\"E\"),IFS(M$row>={$this->batas_min_A_lampau},\"A\",M$row>={$this->batas_min_B_lampau},\"B\",M$row>={$this->batas_min_C_lampau},\"C\", M$row>={$this->batas_min_D_lampau},\"D\", M$row>={$this->batas_min_E_lampau},\"E\"))";
